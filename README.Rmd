...
Following GEM generation and reverse transcription, we isolate the DNA repair fragments from the mRNA by size separation. We then prepare a single-cell repair library that captures DNA repair products, intermediates, and products. 
...
| gene | cell | count |
|Uracil_1| AAACCTGAGACAAGCC | 4 |

- gene is a concatenation of the substrate and the 5´ end alignment position. 
